...
BEGIN
    ...
    -- NOODLES (₱160-280)
    ('Pancit Canton', 'Stir-fried wheat noodles with vegetables and meat', 180.00, noodles_id, 'https://images.unsplash.com/photo-1555126634-323283e090fa?w=400&h=300&fit=crop&auto=format', 20, 380, 1, ARRAY['canton noodles', 'vegetables', 'pork', 'soy sauce'], true, true),
    ('Pancit Bihon', 'Rice noodles with mixed vegetables and chicken', 160.00, noodles_id, 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=400&h=300&fit=crop&auto=format', 18, 320, 1, ARRAY['rice noodles', 'vegetables', 'chicken', 'soy sauce'], false, true),
    ('Pancit Palabok', 'Rice noodles with thick orange sauce and toppings', 200.00, noodles_id, 'https://images.unsplash.com/photo-1563245372-f21724e3856d?w=400&h=300&fit=crop&auto=format', 25, 420, 1, ARRAY['rice noodles', 'shrimp sauce', 'chicharron', 'eggs', 'shrimp'], true, true),
    ('Spaghetti Filipino Style', 'Sweet-style spaghetti with hotdogs and cheese', 190.00, noodles_id, 'https://images.unsplash.com/photo-1551183053-bf91a1d81141?w=400&h=300&fit=crop&auto=format', 15, 480, 0, ARRAY['spaghetti', 'banana catsup', 'hotdogs', 'cheese'], false, true),
    ('Lomi', 'Thick egg noodles in rich broth with meat and vegetables', 170.00, noodles_id, 'https://images.unsplash.com/photo-1569718212165-3a8278d5f624?w=400&h=300&fit=crop&auto=format', 20, 350, 1, ARRAY['lomi noodles', 'pork', 'vegetables', 'egg'], false, true),
    ('Pad Thai Filipino', 'Filipino twist on classic pad thai', 220.00, noodles_id, 'https://images.unsplash.com/photo-1559847844-5315695dadae?w=400&h=300&fit=crop&auto=format', 18, 400, 2, ARRAY['rice noodles', 'shrimp', 'tofu', 'bean sprouts', 'tamarind'], false, true),
    
    -- GRILLED & FRIED (₱200-450)
    ('Inihaw na Liempo', 'Grilled pork belly with java rice', 280.00, grilled_id, 'https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=400&h=300&fit=crop&auto=format', 30, 520, 1, ARRAY['pork belly', 'marinade', 'java rice'], true, true),
    ('Grilled Bangus', 'Whole grilled milkfish stuffed with tomatoes and onions', 320.00, grilled_id, 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=400&h=300&fit=crop&auto=format', 25, 420, 1, ARRAY['bangus', 'tomatoes', 'onions', 'spices'], true, true),
    ('Chicken Inasal', 'Grilled chicken marinated in annatto and spices', 240.00, grilled_id, 'https://images.unsplash.com/photo-1532550907401-a500c9a57435?w=400&h=300&fit=crop&auto=format', 35, 450, 2, ARRAY['chicken', 'annatto', 'lemongrass', 'garlic'], true, true),
    ('Crispy Pata', 'Deep-fried pork knuckles with soy-vinegar dip', 420.00, grilled_id, 'https://images.unsplash.com/photo-1604908176997-125f25cc6f3d?w=400&h=300&fit=crop&auto=format', 45, 680, 1, ARRAY['pork knuckles', 'spices', 'soy sauce', 'vinegar'], false, true),
    ('Fried Chicken', 'Filipino-style fried chicken with gravy', 220.00, grilled_id, 'https://images.unsplash.com/photo-1569058242253-92a9c755a0ec?w=400&h=300&fit=crop&auto=format', 20, 480, 1, ARRAY['chicken', 'flour', 'spices', 'gravy'], false, true),
    ('Grilled Tilapia', 'Whole grilled tilapia with garlic and herbs', 200.00, grilled_id, 'https://images.unsplash.com/photo-1467003909585-2f8a72700288?w=400&h=300&fit=crop&auto=format', 20, 320, 1, ARRAY['tilapia', 'garlic', 'herbs', 'calamansi'], false, true),
    
    -- DESSERTS (₱80-180)
    ('Halo-Halo', 'Mixed shaved ice dessert with various toppings', 150.00, dessert_id, 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400&h=300&fit=crop&auto=format', 8, 280, 0, ARRAY['shaved ice', 'ube', 'beans', 'jelly', 'leche flan', 'ice cream'], true, true),
    ('Leche Flan', 'Rich caramel custard dessert', 120.00, dessert_id, 'https://images.unsplash.com/photo-1571877227200-a0d98ea607e9?w=400&h=300&fit=crop&auto=format', 5, 320, 0, ARRAY['eggs', 'milk', 'sugar', 'vanilla'], true, true),
    ('Ube Ice Cream', 'Purple yam flavored ice cream', 100.00, dessert_id, 'https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?w=400&h=300&fit=crop&auto=format', 2, 180, 0, ARRAY['ube', 'milk', 'cream', 'sugar'], false, true),
    ('Buko Pie', 'Young coconut custard pie', 140.00, dessert_id, 'https://images.unsplash.com/photo-1533134242443-d4fd215305ad?w=400&h=300&fit=crop&auto=format', 5, 250, 0, ARRAY['young coconut', 'custard', 'pie crust'], false, true),
    ('Taho', 'Soft tofu with brown sugar syrup and tapioca pearls', 80.00, dessert_id, 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400&h=300&fit=crop&auto=format', 3, 120, 0, ARRAY['soft tofu', 'brown sugar', 'tapioca pearls'], false, true),
    ('Mais Con Yelo', 'Sweet corn with shaved ice and milk', 90.00, dessert_id, 'https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400&h=300&fit=crop&auto=format', 5, 150, 0, ARRAY['sweet corn', 'shaved ice', 'milk', 'sugar'], false, true),
    
    -- BEVERAGES (₱60-150)
    ('Fresh Buko Juice', 'Fresh young coconut water', 80.00, beverage_id, 'https://images.unsplash.com/photo-1523362628745-0c100150b504?w=400&h=300&fit=crop&auto=format', 3, 60, 0, ARRAY['young coconut'], false, true),
    ('Calamansi Juice', 'Fresh Philippine lime juice', 70.00, beverage_id, 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=400&h=300&fit=crop&auto=format', 5, 40, 0, ARRAY['calamansi', 'water', 'sugar'], true, true),
    ('Sago''t Gulaman', 'Tapioca pearls and gelatin drink', 60.00, beverage_id, 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400&h=300&fit=crop&auto=format', 5, 120, 0, ARRAY['tapioca pearls', 'gelatin', 'brown sugar'], false, true),
    ('Iced Coffee', 'Cold brew Filipino coffee', 90.00, beverage_id, 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=400&h=300&fit=crop&auto=format', 3, 20, 0, ARRAY['coffee beans', 'ice', 'milk'], false, true),
    ('Mango Shake', 'Fresh mango blended with milk and ice', 120.00, beverage_id, 'https://images.unsplash.com/photo-1623065422902-30a2d299bbe4?w=400&h=300&fit=crop&auto=format', 5, 180, 0, ARRAY['mango', 'milk', 'ice', 'sugar'], true, true),
    ('Kapeng Barako', 'Strong Filipino coffee', 80.00, beverage_id, 'https://images.unsplash.com/photo-1517701604599-bb29b565090c?w=400&h=300&fit=crop&auto=format', 5, 15, 0, ARRAY['barako coffee beans'], false, true),
    ('Four Seasons Juice', 'Mixed tropical fruit juice', 100.00, beverage_id, 'https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=400&h=300&fit=crop&auto=format', 8, 150, 0, ARRAY['pineapple', 'orange', 'mango', 'papaya'], false, true),
    
    -- ALCOHOL (₱120-380)
    ('San Miguel Beer', 'Classic Filipino beer', 120.00, alcohol_id, 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=400&h=300&fit=crop&auto=format', 1, 150, 0, ARRAY['hops', 'malt', 'yeast'], true, true),
    ('Red Horse Beer', 'Strong Filipino beer', 140.00, alcohol_id, 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=400&h=300&fit=crop&auto=format', 1, 180, 0, ARRAY['hops', 'malt', 'yeast'], false, true),
    ('Tanduay Rum', 'Premium Filipino rum on the rocks', 180.00, alcohol_id, 'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=400&h=300&fit=crop&auto=format', 2, 120, 0, ARRAY['sugarcane', 'molasses'], false, true),
    ('House Red Wine', 'Local red wine blend', 250.00, alcohol_id, 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=400&h=300&fit=crop&auto=format', 1, 140, 0, ARRAY['grapes'], false, true),
    ('Lambanog', 'Traditional coconut wine', 160.00, alcohol_id, 'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=400&h=300&fit=crop&auto=format', 2, 180, 0, ARRAY['coconut sap'], false, true),
    ('Basi Wine', 'Traditional sugarcane wine', 200.00, alcohol_id, 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=400&h=300&fit=crop&auto=format', 1, 160, 0, ARRAY['sugarcane'], false, true);
